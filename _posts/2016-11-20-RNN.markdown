...
& = \sum_k \frac{\partial E_p}{\partial net_k} \frac{\partial net_k}{\partial o_j} \frac{\partial o_j}{\partial u_{i,j}}  \\
& = \sum_k \frac{\partial E_p}{\partial net_k} v_ \frac{\partial o_j}{\partial u_{i,j}} \\
& = \frac{\partial E_p}{\partial o_k}\frac{\partial o_k}{\partial net_k}o_j \\
& = (o_k-d_k)o_k(1-o_k)o_j
\end{align}
$$
